...
num_epochs = 35000  # number of epochs for training
...
# Loading the dataset
positions = np.loadtxt('/home/mateusn/Downloads/Programação/CT-213/lab7_ct213_2020/positions.txt')
...
model.fit(input, expected_output, batch_size=len(input), epochs=num_epochs)
