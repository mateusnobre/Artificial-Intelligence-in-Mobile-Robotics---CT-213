...
num_iterations =  500 # number of epochs for training
...
# Loading the image
image = imread('/home/mateusn/Downloads/Programação/CT-213/lab6_ct213_2020/nao1.jpg')

# Setting the random seed of numpy's random library for reproducibility reasons
np.random.seed(0)

# Loading the dataset
data = np.loadtxt('/home/mateusn/Downloads/Programação/CT-213/lab6_ct213_2020/nao1.txt')
